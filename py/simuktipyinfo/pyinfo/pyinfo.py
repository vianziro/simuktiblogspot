...
<table>
  ...
  <tr class="copyright"><td class="copyright">
	...
	<p>Copyright &copy; 2009 <a href="http://www.twoevils.org">April King</a>; <a href="http://www.twoevils.org/files/pyinfo.txt">source code</a> released under the BSD license. Or checkout SVN trunk of <a href="http://code.google.com/p/simuktiblogspot/source/browse/trunk/py/simuktipyinfo">this sample pyinfo.</a></p></td></tr>
</table>
"""
